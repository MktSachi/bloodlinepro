        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <?php if (!empty($requests)): ?>
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-0"><i class="fas fa-hospital me-2"></i>Blood Requests for
                                <?= htmlspecialchars($requestDate) ?></h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php foreach ($requests as $request): ?>
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars(date('H:i:s', strtotime($request['requestDate']))) ?>
                                                </td>
                            ...
                            <a href="DownloadReqReport.php?download=pdf&date=<?= urlencode($requestDate) ?>"
