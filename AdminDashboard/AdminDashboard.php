<?php include "AdminDashboardProcess.php"?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
          ...
          <div class="card h-100">
            <div class="card-body d-flex justify-content-between align-items-center">
              <div>
                ...
                <p class="card-text"><?php echo $totalHealthcareProfessionals; ?></p> <!-- Display total healthcare professionals -->
              </div>
          ...
          <div class="card h-100">
            <div class="card-body d-flex justify-content-between align-items-center">
              <div>
                ...
                <p class="card-text"><?php echo $totalHospitals; ?></p> <!-- Display total hospitals -->
              </div>
