    ...
    <div class="w3-main" style="margin-left:240px;margin-top:0px;">
        <div class="container">
            ...
            <div class="operation-links">
                <a href="Reminder.php" target="contentFrame" class="btn btn-dark" id="reminderBtn" onclick="showButton('reminder', 'Reminder.php')">
            ...
            <div id="welcomeMessage" class="welcome-message">
                <h4>Welcome to Notifications</h4>
