...
<body>
    ...
    <div class="w3-main" style="margin-left:240px;margin-top:0px;">
        <div class="container">
            ...
            <div class="operation-links">
                <a href="CreateDonor/CreateDonor.php" target="contentFrame" class="btn btn-primary" id="createBtn" onclick="showButton('create', 'CreateDonor/CreateDonor.php')">
                    <i class="fa fa-plus" style="margin-right: 5px;"></i>Create Donor
                </a>

                <a href="View/ViewDonor.php" target="contentFrame" class="btn btn-info" id="viewBtn" onclick="showButton('view', 'View/ViewDonor.php')">
            ...
            <div id="welcomeMessage" class="welcome-message">
                <h4>Welcome to Donor Account Management</h4>
    ...
    <script>
        const buttonIds = ['createBtn', 'viewBtn'];
