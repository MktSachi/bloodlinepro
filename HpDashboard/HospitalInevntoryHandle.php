...
<body>
    ...
    <div class="w3-main" style="margin-left:240px;margin-top:0px;">
        <div class="container">
            ...
            <div class="operation-links">
                <a href="BloodInventory/BloodCount.php" target="contentFrame" class="btn btn-primary" id="countBtn" onclick="showButton('count', 'BloodInventory/BloodCount.php')">
                ...
                <a href="BloodInventory/StatusOfBlood.php" target="contentFrame" class="btn btn-primary" id="StatusBtn" onclick="showButton('Status', 'BloodInventory/StatusOfBlood.php')">
            ...
            <div id="welcomeMessage" class="welcome-message">
                <h4>Welcome to Blood Inventory Management</h4>
    ...
    <script>
        const buttonIds = ['countBtn', 'donationBtn', 'usageBtn', 'PatientBtn', 'StatusBtn'];
